...
"""Unified pytest suite for Wrapper-118.
...
def test_main_window_title_is_dynamic_and_matches_wrapper_name():
    ...
    mod = load_fix_module()
    assert getattr(mod, 'WRAPPER_NAME', '') == 'Wrapper-118'
    assert getattr(mod, 'MAIN_WINDOW_TITLE', '') == 'Wrapper-118 Comm-SCI-Control'
